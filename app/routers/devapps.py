...
# Create new app
@router.post("/api/dev/apps", response_model=AppsModel, tags=["Dev Apps"])
...
@router.get("/api/dev/apps", response_model=List[AppsResponseModel], tags=["Dev Apps"])
...
@router.delete("/api/dev/apps/{app_id}", response_model=AppsResponseModel, tags=["Dev Apps"])
...
# Update app details
@router.put("/api/dev/apps/{app_id}", response_model=AppsResponseModel, tags=["Dev Apps"])
